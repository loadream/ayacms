...
<ul class="nav nav-secondary nav-stacked">
  ...
  <li <?php echo $act=='com'?'class="active"':''?>><a href="?action=comment&channelid=<?php echo $channelid?>&in_module=1">评论</a></li>
  ...
  <li <?php echo $act=='pv'?'class="active"':''?>><a href="?action=pv&channelid=<?php echo $channelid?>&in_module=1">权限</a></li>
