...
if($CHANNELS[$channelid]['module']!='picture')
	return '{diy "picture_title"}$channelid不存在';
...
$items=array ();
$rs=$db->query("SELECT * FROM ".PF."picture_".$channelid." WHERE {$where} order by {$order} LIMIT 0,".$page*$number);
